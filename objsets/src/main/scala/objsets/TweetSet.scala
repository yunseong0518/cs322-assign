...
object GoogleVsApple {
  ...
  lazy val googleTweets: TweetSet = allTweets.filter((tw: Tweet) => google.exists(msg => tw.text.contains(msg)))
  lazy val appleTweets: TweetSet = allTweets.filter((tw: Tweet) => apple.exists(msg => tw.text.contains(msg)))
